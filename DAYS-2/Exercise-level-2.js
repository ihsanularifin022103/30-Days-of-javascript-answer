...
console.log(typeof('10')==typeof(10)) // result false
...
var text2 = 'You cannot end a sentence with because because because is a conjunction'
console.log(text2.match(/because/gi).toString())